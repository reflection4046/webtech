...
<body>
 ...
 <form action="controller/updateProduct.php" method="POST" enctype="multipart/form-data">
  <fieldset style="width: 80%;">
    ...
    <input type="text" required id="name" name="name" value="<?php echo $product['name']?>"><br>
    <label for="buying_price">Buying Price</label><br>
    <input type="number" required id="bprice" name="bprice" min="1" step=".001" value="<?php echo $product['bprice']?>"><br>
    <label for="sprice">Selling price</label><br>
    <input type="number" required id="sprice" name="sprice" min="1" step=".001" value="<?php echo $product['sprice']?>"><br>
    <hr>
